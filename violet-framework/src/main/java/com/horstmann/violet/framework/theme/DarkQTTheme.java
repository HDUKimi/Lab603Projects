 ...
 * 
 */
public class DarkQTTheme extends AbstractTheme
{

	@Override
	public ThemeInfo getThemeInfo() {
		return new ThemeInfo("Dark QT", DarkQTTheme.class, PgsLookAndFeel.class);
	}
...
//工具栏外部背景颜色
    ...
    private class BlackTheme extends PgsTheme
    {
        public BlackTheme()
        {
            ...
            setSecondary3(new ColorUIResource(new Color(255,255,255)));
            ...
            setDefaults(new Object[]
            {
                    ...
                    new ColorUIResource(214,219,233),
                    ...
                    "MenuBarMenu.isFlat",
                    Boolean.FALSE,
                    "MenuBarMenu.selectedforeground",
                    getBlack(),
