...
public class EclipseTheme extends AbstractTheme
{
	...
	public ThemeInfo getThemeInfo() {
		return new ThemeInfo("Eclipse Theme", EclipseTheme.class, PgsLookAndFeel.class);
	}
    ...
    private class BlackTheme extends PgsTheme
    {
        public BlackTheme()
        {
            ...
            setDefaults(new Object[]
            {
                    ...
                    new ColorUIResource(246,248,252),
                    "MenuBar.gradientMiddle",
                    new ColorUIResource(212,219,237),
                    "MenuBar.gradientEnd",
                    new ColorUIResource(225,230,246),
