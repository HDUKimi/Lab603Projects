...
import com.horstmann.violet.application.gui.opreationTreePane.ModelSequenceTreePanel;
import com.horstmann.violet.application.gui.opreationTreePane.ModelTimingTreePanel;
import com.horstmann.violet.application.gui.opreationTreePane.SequenceTreePanel;
...
//		diagrampanel.add(diagrambuttonpanel5);
	...
	private void initToolButton() {
		...
		ImageIcon icon1 = new ImageIcon(path + "zoomin.png");
		icon1.setImage(icon1.getImage().getScaledInstance(16,16, Image.SCALE_DEFAULT));
		ImageIcon icon2 = new ImageIcon(path + "delete.png");
