...
public class ValidationResultPanel extends JPanel{
	...
	private void initFiveNamePanel() {
		...
		fivenamelabel.setText("评估结果： ");
		fivenamelabel.setFont(new Font("微软雅黑", Font.PLAIN, 12));
...
//		threeresultscrollpanel.setBorder(null);
	...
	private void initTabPanel() {
		...
		validationlabeltab5.setText("评估结果");
		validationlabeltab5.setForeground(new Color(0,0,0));
		validationlabeltab5.setFont(new Font("微软雅黑", Font.PLAIN, 12));
