...
public class PerformanceXML2 {
	public static void main(String[] args) throws Exception {
		...
		String xml = "EA性能测试-起飞高度V9ForXStream.xml";
...
//				System.out.println("result--------------"+result);
			...
			System.out.println("抽象用例个数："+testcaseNum);
		...
		System.out.println("抽象用例总个数："+number);

		OutputFormat format = OutputFormat.createPrettyPrint();
		//6、生成xml文件
		File file = new File("E:\\XML\\test\\EA性能测试-起飞高度V9ForXStream+perform.xml");   
		XMLWriter writer;
		try {
