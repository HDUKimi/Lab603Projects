...
//		titlepanel.setBorder(BorderFactory.createEmptyBorder(2, 10, 0, 0));
	...
	protected void saveFile() {
		...
		JFileChooser fileChooser = new JFileChooser(localfile);// ³õÊ¼»¯Ò»¸öÎÄ¼þÂ·¾¢Ñ¡Ôñ¿ò
		fileChooser.setFileSelectionMode(JFileChooser.FILES_ONLY);
		fileChooser.setCurrentDirectory(localfile);
//		fileChooser.setAcceptAllFileFilterUsed(false);
//		fileChooser.showSaveDialog(fileChooser);
		
		FileFilter filter=new FileNameExtensionFilter("ÎÄ±¾ÎÄ¼þ(txt)", "TXT");
