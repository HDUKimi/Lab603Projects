...
public class TimeTestSituationDetailPanel extends JPanel{
	...
	public TimeTestSituationDetailPanel(String normaltext, String abnormaltext, String imagepath) {
	...
	private void initAllDetailLabelPanel() {
		...
		detailheadlabel1.setText("»ù±¾ÒªÇó£º");
...
//		detaillabel1.setBorder(BorderFactory.createEmptyBorder(0, 0, 10, 0));
		...
		detailheadlabel2.setText("²âÊÔÊý¾Ý£º");
...
//		detaillabelpanel2.setOpaque(false);
		...
		detaillabelpanel2.setOpaque(false);
		detaillabelpanel2.setBorder(BorderFactory.createEmptyBorder(0, 20, 0, 0));
