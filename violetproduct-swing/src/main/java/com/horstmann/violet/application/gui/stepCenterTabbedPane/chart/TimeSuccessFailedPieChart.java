...
public class TimeSuccessFailedPieChart {
	...
	public TimeSuccessFailedPieChart(List<Integer> caseSuccess, List<Integer> caseFailed) {
		this.caseSuccess=caseSuccess;
		this.caseFailed=caseFailed;
	}
	
	public TimeSuccessFailedPieChart(int caseSuccessSize, int caseFailedSize) {
