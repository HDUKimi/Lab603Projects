...
public class ReadTimingDiagram {
	ArrayList<EALifeline> umlLifelines = new ArrayList<EALifeline>();
	ArrayList<EAMessage> umlConnectors = new ArrayList<EAMessage>();
	ArrayList<EADiagramsData> umlAllDiagramData = new ArrayList<EADiagramsData>();
	...
	public void load(Element root) throws Exception {
		...
		while (connectorIterator.hasNext()) {		//遍历消息
			...
			EAMessage connectorTemp = new EAMessage();
			...
			connectorTemp.setDuration(connectorElement.element("labels").attributeValue("lt"));
	...
	private void setDiagramsIds(Element root) {
		...
		for(Iterator<Element>  EADiagramsListIterator=EADiagramsList.iterator();EADiagramsListIterator.hasNext();)
		{
			...
			//创建DiagramsData对象
			EADiagramsData diagramData = new EADiagramsData();
			diagramData.ids = ids;
	...
	public ArrayList<EALifeline> getTimingLine() {
		return umlLifelines;
	}

	public ArrayList<EAMessage> getConnector() {
		return umlConnectors;
	}
	
	public ArrayList<EADiagramsData> getUmlAllDiagramData() {
