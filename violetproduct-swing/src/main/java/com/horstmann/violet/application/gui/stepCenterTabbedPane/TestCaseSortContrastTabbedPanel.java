...
public class TestCaseSortContrastTabbedPanel extends JPanel{
	...
	public TestCaseSortContrastTabbedPanel(MainFrame mainFrame,IWorkspace workspace){
...
//		toolpanel.add(toolbuttonpanel4);
	...
	private void initMoviePanel() {
		...
		moviepanel.getMovieLabel().setText("正在进行重要度排序");
...
//		tableresultpanel.add(resultpanel);
	...
	public List<TestCaseSortContrastPartPanel> getTestCaseSortContrastPartPanelList() {
		return testCaseSortContrastPartPanelList;
	}

	public void setTestCaseSortContrastPartPanelList(
			List<TestCaseSortContrastPartPanel> testCaseSortContrastPartPanelList) {
		this.testCaseSortContrastPartPanelList = testCaseSortContrastPartPanelList;
	}
