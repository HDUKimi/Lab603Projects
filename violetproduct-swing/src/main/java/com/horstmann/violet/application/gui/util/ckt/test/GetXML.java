...
public class GetXML {
	public static void main(String[] args) {
		...
		String xml="UAVForXStream3.8.0.xml";
...
//						result1 = ResultNoBorder.getResult(inn);
						result1 = ResultNoBorder.getResult(inn);
...
//								result2 = ResultNoBorder.getResult(tra);
...
//			}
      ...
      //6、生成xml文件
		...
		File file = new File("E:\\项目\\xml\\UAVForXStream3.8.0.xml------.xml");
