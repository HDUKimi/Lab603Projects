...
public class TestRegression6 {
	...
	public static List<Double> scorelist=new ArrayList<>();
...
//			}
	...
	private static void Write(double score) throws IOException {
...
//    		t1=(int) Math.round(resultlist.get(i).getDouble(0));
//    		t2=(int) Math.round(outlist.get(i).getDouble(0));
//    		if(t1==t2){
//    			count++;
//    		}
