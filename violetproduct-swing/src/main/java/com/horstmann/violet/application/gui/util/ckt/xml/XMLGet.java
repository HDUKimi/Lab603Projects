...
public class XMLGet {
	public static void main(String[] args) {
		...
		// String xml = "EA4.1.0-function-1ForXStream.xml";
		// String xml = "EA4.1.0 功能场景1ForXStream.xml";
		String xml = "EA4.1.0 功能场景2ForXStream.xml";

		// String xml = "EA4.1.0-function-2ForXStream.xml";
		// Automatic automatic =
		// GetAutomatic.getAutomatic("UAVForXStream3.8.0.xml");
		...
		// File file = new
		// File("E:\\项目\\xml\\arm_motors_checkForXStream1.01.xml");
		// File file = new
		// File("E:\\项目\\xml\\UAVForXStreamPerfromTestV2+border+path.xml");
		// File file = new
		// File("E:\\项目\\xml\\UAVForXStream3.8.2.0.xml+border+path.xml");
		// File file = new File("E:\\XML\\test\\EA4.1.0 功能场景1ForXStream.xml");
		File file = new File("E:\\XML\\test\\EA4.1.0 功能场景2ForXStream+path.xml");
