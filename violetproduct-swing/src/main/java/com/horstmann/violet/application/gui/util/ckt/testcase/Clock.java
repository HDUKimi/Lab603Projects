...
public class Clock {
	public static void main(String[] args) {
		...
		//String xml="rc_loop1.01.xml";//有时间约束
...
//					System.out.println("types:"+t);
		...
		System.out.println("状态个数："+new_automatic.getStateSet().size());
		int k=0;
		...
		System.out.println("状态个数："+aTDRTAutomatic.getStateSet().size());
		int k=0;
		...
		for(Automatic a:testCase){
			System.out.println("时间自动机名字:"+a.getName());
			System.out.println("时间自动机时钟集合：");
