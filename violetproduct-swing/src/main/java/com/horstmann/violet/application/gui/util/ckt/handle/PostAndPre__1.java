				...
				if(t.getSource().equals(x_name)&&t.getTarget().equals(p_name)){//存在x-->p
					...
					if(t.getSource().equals(x_position)&&t.getTarget().equals(p_position)){//存在x.position-->p.position
						if(x_position.equals(p_position)){//x.position==p.position
							if(Godirectly_3.goDirectly(x_DBM, p_DBM)!=null){posts.add(p);}	
						}
						...
						if(!x_name.equals(p_name)&&x_position.equals(p_position)){//x.position==p.position
							if(Godirectly_3.goDirectly(x_DBM, p_DBM)!=null){
								posts.add(p);
								break;
							}	
						}
				...
				if(t.getSource().equals(p_name)&&t.getTarget().equals(x_name)){
					...
					if(t.getSource().equals(p_position)&&t.getTarget().equals(x_position)){
						if(x_position.equals(p_position)){
							if(Godirectly_3.goDirectly(p_DBM, x_DBM)!=null){posts.add(p);}	
						}
						else{
							if(t.getResetClockSet().size()!=0){
						...
						if(!x_name.equals(p_name)&&x_position.equals(p_position)){
							if(Godirectly_3.goDirectly(p_DBM, x_DBM)!=null){
								posts.add(p);
								break;
							}	
						}
