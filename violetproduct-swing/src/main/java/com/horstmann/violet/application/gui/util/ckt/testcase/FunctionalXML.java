...
/**
 * 最终生成xml文档   ++有边界值border  ++性能测试 屏蔽带有@@的边
 * 加边界 in里面是--拆开求解后深度组合  condition是一体求解 
 */
...
//		File file = new File("E:\\项目\\xml\\UAVForXStream3.3.0.xml");
		File file = new File("E:\\项目\\xml\\UAVForXStream3.8.2.0.xml+++++++border.xml");
