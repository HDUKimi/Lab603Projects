...
public class PerformanceTimeSpeedBarChart {

private List<Pair> resultlist;
	
	public PerformanceTimeSpeedBarChart(List<Pair> resultlist){
...
//		System.out.println(resultlist.size());
		...
		Integer[] timedata=new Integer[resultlist.size()];
...
//		String[] categories = { "模块A", "模块B", "模块C", "模块D" };
		...
		// 柱子名称：柱子所有的值集合
		series.add(new Serie("时间", timedata));
...
//		series.add(new Serie("Berlin", new Double[] { 42.4, 33.2, 34.5, 39.7, 52.6, 75.5, 57.4, 60.4, 47.6, 39.1, 46.8, 51.1 }));
	...
	public ChartPanel createChart() {
		// 2：创建Chart
		JFreeChart chart = ChartFactory.createBarChart("", "风速", "高度", createDataset());
		// 3:设置抗锯齿，防止字体显示不清楚
