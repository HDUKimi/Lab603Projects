...
public class PerformanceXML1 {
	...
	public static void getXML(String xml,int Fspeed) throws Exception {
...
//			System.out.println("result--------------"+result);
		...
		//6、生成xml文件
		File file = new File("E:\\项目\\XML\\UAVForXStreamV9+1+border+path+perform.xml");   
		XMLWriter writer;
		try {
