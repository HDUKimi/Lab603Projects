...
public class Godirectly_3 {
	...
	public static DBM_element[][] goDirectly(DBM_element[][] DBM1,DBM_element[][] DBM2) {
		if(Commonboundary__1.commonboudary(DBM1, DBM2)!=null){
			DBM_element[][] comboundary=Commonboundary__1.commonboudary(DBM1, DBM2);//获取DBM1, DBM2的公共边界
