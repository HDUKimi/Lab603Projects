...
//		attributetable.getColumnModel().getColumn(4).setCellRenderer(new MyAllLabelRenderer());
		...
		attributetable.getColumn("风速").setPreferredWidth(100);
		attributetable.getColumn("风速").setMinWidth(100);
		attributetable.getColumn("起飞高度").setPreferredWidth(100);
		attributetable.getColumn("起飞高度").setMinWidth(100);
		attributetable.getColumn("剩余电量").setPreferredWidth(100);
		attributetable.getColumn("剩余电量").setMinWidth(100);
