...
public class TestCaseConfirmResultPanel extends JPanel{
	...
	private void initOneNamePanel() {
		...
		onenamelabel.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 12));
...
//		testcaseinfortable.setDefaultRenderer(Object.class, renderer1);
	...
	private void initTabPanel() {
		...
		testcaselabeltab1.setText("œÍœ∏–≈œ¢");
		testcaselabeltab1.setForeground(new Color(0,0,0));
		testcaselabeltab1.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 12));
