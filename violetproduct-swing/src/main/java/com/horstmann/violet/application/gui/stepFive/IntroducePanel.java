...
public class IntroducePanel extends JPanel{
	...
	private void initIntroducePanel() {
		...
		introduceLabel1.setText("½éÉÜ");
		introduceLabel1.setBorder(BorderFactory.createEmptyBorder(30, 35, 0, 0));
		introduceLabel1.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 27));

		introduceLabel2.setText("<html><body>" + "<p>µÚÒ»²½£º¿É¿¿ÐÔÆÀ¹À</p><br>" + "<p>µÚ¶þ²½£º</p><br>"
				 + "</body></html>");
		introduceLabel2.setBorder(BorderFactory.createEmptyBorder(20, 35, 0, 30));
		introduceLabel2.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 15));
