...
public class TimeTestCaseChartTabbedPanel extends JPanel{
...
//	private JButton toolbutton1;
	...
	public TimeTestCaseChartTabbedPanel(MainFrame mainFrame){ 
...
//		successfailedattributetable.setSelectionBackground(new Color(250, 248, 236));
	...
	private void initFailedStatisticsTablePanel() {
		...
		String[] columnNames = { " ","测试用例有误", "不满足时间约束", "失败测试用例总数"};
		String[][] tabelValues = {};
...
//		failedstatisticsattributetable.setSelectionBackground(new Color(250, 248, 236));
		...
		failedstatisticsattributetable.getColumn("不满足时间约束").setPreferredWidth(100);
		failedstatisticsattributetable.getColumn("不满足时间约束").setMinWidth(100);
