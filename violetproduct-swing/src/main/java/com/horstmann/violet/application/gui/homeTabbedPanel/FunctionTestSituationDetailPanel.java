...
public class FunctionTestSituationDetailPanel extends JPanel{
	...
	public FunctionTestSituationDetailPanel(String normaltext, String abnormaltext, String imagepath) {
