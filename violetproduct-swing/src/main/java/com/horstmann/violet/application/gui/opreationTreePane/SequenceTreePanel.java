...
//		                        }
								...
								if(parentNode.isLeaf()){
									...
									mainFrame.getConsolePartPanel().getTextarea().append("删除顺序图 "+mainFrame.getStepOneCenterTabbedPane().getSelectedButtonTabbedPanel().getTabbedbutton().getText()+" 的绘图面板\n");
								}
